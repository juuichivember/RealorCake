...
- แก้มีรายละเอียดดังนี้:
    1. ทำ balingPage มี 4 step 
        ...
        - 2 cutting กด knife animation ตัด
        - 3 frosting กด piping bag เลือกไส้เค้ก filling
    2. แก้ปัญหาเพิ่มการนับคะแนนส่วนของ filling
    3. ใส่ sound

- ปัญหา 
    1. กดไปๆกลับๆไม่ได้ เหมือนทุกปุ่มยังกดได้ครั้งเดียว จัดการสเตจปุ่มกดต่างๆ ได้ไม่ดี แต่เล่นแบบตรงไปตรงมาได้
